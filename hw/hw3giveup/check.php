...
<?php
    ...
    if(!empty($_POST['submitted']))//if name is blank this code will run
    {
        ...
        $answer4 = $_POST['question-4-answers[1]'];
        $answer5 = $_POST['question-4-answers[3]'];
        ...
        if ($answer1 == "sacramento") { $totalCorrect++; }

        if ($answer2 == "thanos") { $totalCorrect++; }

        if ($answer3 == "4") { $totalCorrect++; }

        if ($answer4 == "transmission") { $totalCorrect++; }

        if ($answer5 == "engine") { $totalCorrect++; } 
